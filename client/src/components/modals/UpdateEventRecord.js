...
import {changeStatusToInProcess, changeStatusToApproved, changeStatusToCanceled} from '../../http/eventRecordAPI';
import {Context} from '../..';
import {toJS} from "mobx"

const UpdateEventRecord = observer(({show, onHide, record}) => {
...
export default UpdateEventRecord;
